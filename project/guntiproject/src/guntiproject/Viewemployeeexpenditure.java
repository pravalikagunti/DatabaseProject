...
public class Viewemployeeexpenditure extends javax.swing.JFrame {
         DefaultTableModel tm;
    /**
     * Creates new form Viewemployeeexpenditure
     */
...
catch(Exception e)
{
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "AMOUNT", "DESCRIPTION", "EXP_DATE", "ID"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {    
          ...
          Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","ramamurthi","ramamurthi");
               ...
               PreparedStatement ps1=con.prepareStatement("update EMPEXP  set "+unc+" = ? where "+unp+" =? ");
...
v.add(rs.getString(6));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {    
          ...
          Connection con= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","ramamurthi","ramamurthi");
               ...
               PreparedStatement ps1=con.prepareStatement("delete  EMPEXP where ID='"+id+"' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Viewemployeeexpenditure.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Viewemployeeexpenditure().setVisible(true);
            }
        });
    }
