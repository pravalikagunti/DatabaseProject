...
public class Expenditure extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(490, 340, 150, 80);
        ...
        jButton1.setBounds(340, 450, 100, 33);

        jButton2.setFont(new java.awt.Font("Segoe UI Semilight", 1, 18)); // NOI18N
        jButton2.setText("Cancel");
        getContentPane().add(jButton2);
        jButton2.setBounds(500, 450, 100, 33);

        jLabel5.setFont(new java.awt.Font("Segoe UI Semilight", 1, 24)); // NOI18N
        jLabel5.setText("Exptype");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(270, 180, 170, 70);

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Material", "Transport", "Other" }));
        getContentPane().add(jComboBox2);
        jComboBox2.setBounds(490, 190, 150, 50);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     String expd =jTextField1.getText();
        if(expd.equals(""))
          {
                 JOptionPane.showMessageDialog(jButton1,"please enter expd");
          }
          else{
             for(int i=0;i<expd.length();i++)
           {
              char c= expd.charAt(i);
              if(Character.isDigit(c))
              {
              }
              else 
              {
                 JOptionPane.showMessageDialog(jButton1,"please enter digits only");
                 break;
  ...
  try{
         ...
         PreparedStatement ps= con.prepareStatement("insert into MATEXPE values(?,?,?,?)");
         ...
         JOptionPane.showMessageDialog(rootPane, "ADDed exp suceesfullly");
         }
         else
         {
         JOptionPane.showMessageDialog(rootPane, "not ADDed exp suceesfullly");
